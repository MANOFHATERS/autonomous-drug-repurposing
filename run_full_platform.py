...
run_full_platform.py has been moved to scripts/legacy/run_full_platform.py.
...
def main() -> int:
    print(
        "DEPRECATION WARNING (RT-013): run_full_platform.py is DEPRECATED. "
        ...
        "directly. The original is preserved at scripts/legacy/run_full_platform.py.",
        file=sys.stderr,
    )
