...
# │    5. If STATUS=DONE → already fixed, verify then skip           │
# │    6. If your issue is NOT listed → add it to the table first    │
# └──────────────────────────────────────────────────────────────────┘
#
...
#
# ┌──────────────────────────────────────────────────────────────────┐
# │  WHY THIS WORKS (no CI, no sequencing):                          │
# │    - Each issue has exactly ONE owner at any time.               │
# │    - The owner has exclusive rights to touch ANY file listed in  │
# │      that issue's FILES scope.                                   │
# │    - The pre-commit hook (scripts/pre_commit_issue_guard.py)     │
# │      blocks any commit where a file is touched by someone who    │
# │      doesn't own the issue that file belongs to.                 │
# │    - Conflicts are detected LOCALLY in <0.1s — no CI round-trip. │
# └──────────────────────────────────────────────────────────────────┘
#
# ┌──────────────────────────────────────────────────────────────────┐
...
#   STATUS     — AVAILABLE | CLAIMED | DONE | WONTFIX
#   AGENT_ID   — who claimed it (or "—" if AVAILABLE/DONE)
...
# ISSUE_ID | TITLE | PHASE | STATUS | AGENT_ID | BRANCH | CLAIMED_AT | FILES | MERGED | NOTES
# ====================================================================
...
P1-001 | chembl dead second CSV read removed | 1 | DONE | agent-v100 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/pipelines/chembl_pipeline.py | 5287742 | —
P1-002 | neo4j schema-qualified table lookup | 1 | DONE | agent-v100 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/exporters/neo4j_exporter.py | 5287742 | —
P1-003 | docker-compose 3 new mounts | 1 | DONE | agent-v100 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/docker-compose.yml | 5287742 | —
P1-004 | confidence tier Piñero mislabel (sub_weak/weak/strong) | 1 | DONE | agent-v100 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/cleaning/confidence.py,phase1/config/settings.py,phase1/database/models.py,phase1/database/migrations/012_confidence_tier_pinero_alignment.sql,phase1/database/migrations/012_confidence_tier_pinero_alignment_rollback.sql,phase1/pipelines/schema/v1.json,phase1/pipelines/__init__.py,phase1/cleaning/SCHEMA.md,phase1/pipelines/disgenet_pipeline.py | 5287742 | 7-site lockstep update
P1-005 | is_homodimer server_default=FALSE | 1 | DONE | agent-v100 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/database/models.py | 5287742 | —
P1-006 | _CircuitBreaker.state pure observation | 1 | DONE | agent-v100 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/database/connection.py | 5287742 | —
P1-007 | OMIM mapping_key column drives re-map | 1 | DONE | agent-v100+agent-v101 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/cleaning/missing_values.py,phase1/pipelines/omim_pipeline.py | 5287742 | merged with v101 lazy-import fix
...
P1-009 | pubchem_load wire removed from trigger_phase2 | 1 | DONE | agent-v100 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/dags/master_pipeline_dag.py | 5287742 | —
...
P1-012 | normalizer circuit breaker thread safety | 1 | DONE | agent-v100+agent-v101 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/cleaning/normalizer.py,phase1/_circuit_breaker.py | 5287742 | merged with v101 _NormalizerCircuitBreaker wrapper
...
P1-018 | DisGeNET centered ±50% jitter | 1 | DONE | agent-v100 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/pipelines/disgenet_pipeline.py | 5287742 | —
...
P1-021 | stereo collapse WARNING + lineage | 1 | DONE | agent-v100 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/cleaning/deduplicator.py | 5287742 | —
...
P1-024 | SYNTH% CHECK LENGTH<=27 cap | 1 | DONE | agent-v100 | fix/p1-001-024-forensic-root-fix-v100 | 2025-07-11T23:47Z | phase1/database/models.py | 5287742 | —
