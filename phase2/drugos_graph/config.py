...
class TransEConfig:
    ...
    # (see graph_transformer_model.py and the Phase 3 config). A TransE
    # checkpoint trained with embedding_dim=256 CANNOT be loaded into a
    # Phase 3 model expecting 128-dim embeddings — the shape mismatch
    # raises ``RuntimeError: Error(s) in loading state_dict for
    # GraphTransformerModel: size mismatch for entity_embeddings.weight``.
    #
